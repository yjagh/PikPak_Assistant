...
(() => {
  ...
  var CONF = {
    ...
    icons: {
      ...
      dup: `<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2"/><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1"/></svg>`,
  ...
  var fmtDate = (t) => t ? new Date(t).toLocaleDateString() : "-";
  var fmtDur = (s) => {
    if (!s) return "";
    s = parseInt(s, 10);
...
<div style="font-size:13px; line-height:1.7; color:var(--pk-fg);">
    ...
    tip_player_prev: "이전 영상",
    tip_player_next: "다음 영상",
    tip_player_shuffle: "랜덤 재생",
    tip_player_playlist: "재생 목록",
    tip_player_sub: "자막 설정",
    btn_player_sub: "자막",
    tip_player_ext: "외부 플레이어로 열기",
    tip_player_close: "닫기 (Esc)",
    lbl_playlist: "재생 목록",
    loading_subs: "자막 불러오는 중...",
    loading_translating: "자막 번역 중...",
    loading_restart_player: "플레이어와 자막 재시작 중...",
    loading_local_sub: "로컬 자막 불러오는 중...",
    msg_local_sub_loaded: "로컬 자막을 불러왔습니다!",
    msg_translate_target: "자동 번역 대상: {lang}",
    msg_player_fallback: "향상된 플레이어 로드 실패. 기본 플레이어를 사용합니다.",
    btn_close: "닫기",
    label_preview: "미리보기",
    msg_copy_fail: "복사 실패",
    msg_link_fail: "링크를 가져올 수 없습니다.",
    msg_done: "완료",
    msg_error: "오류 발생",
    err_load: "불러오기 실패",
    err_search: "검색 오류",
    ...
    err_rename: "이름 변경 오류",
    err_generic: "오류",
    btn_download_menu: "내려받기 / 내보내기",
    tip_download_menu: "선택 항목 다운로드 또는 링크 내보내기",
    col_created: "생성 일자",
    btn_filter: "필터",
...
<div style="font-size:13px; line-height:1.6; color:var(--pk-fg);">
    ...
    tip_player_prev: "Previous video",
    tip_player_next: "Next video",
    tip_player_shuffle: "Shuffle",
    tip_player_playlist: "Playlist",
    tip_player_sub: "Subtitle settings",
    btn_player_sub: "Subtitles",
    tip_player_ext: "Open in external player",
    tip_player_close: "Close (Esc)",
    lbl_playlist: "Playlist",
    loading_subs: "Loading subtitles...",
    loading_translating: "Translating subtitles...",
    loading_restart_player: "Restarting player & subtitles...",
    loading_local_sub: "Loading local subtitle...",
    msg_local_sub_loaded: "Local subtitle loaded!",
    msg_translate_target: "Auto-translate target: {lang}",
    msg_player_fallback: "Failed to load enhanced player. Using basic player instead.",
    btn_close: "Close",
    label_preview: "Preview",
    msg_copy_fail: "Copy failed",
    msg_link_fail: "Could not get the link.",
    msg_done: "Done",
    msg_error: "An error occurred",
    err_load: "Failed to load",
    err_search: "Search error",
    err_paste: "Paste error",
    err_rename: "Rename error",
    err_generic: "Error",
    btn_download_menu: "Download / Export",
    tip_download_menu: "Download selected items or export their links",
    col_created: "Created",
    btn_filter: "Filter",
...
<div style="font-size:13px; line-height:1.6; color:var(--pk-fg);">
    ...
    tip_player_prev: "前の動画",
    tip_player_next: "次の動画",
    tip_player_shuffle: "ランダム再生",
    tip_player_playlist: "再生リスト",
    tip_player_sub: "字幕設定",
    btn_player_sub: "字幕",
    tip_player_ext: "外部プレーヤーで開く",
    tip_player_close: "閉じる (Esc)",
    lbl_playlist: "再生リスト",
    loading_subs: "字幕を読み込み中...",
    loading_translating: "字幕を翻訳中...",
    loading_restart_player: "プレーヤーと字幕を再起動中...",
    loading_local_sub: "ローカル字幕を読み込み中...",
    msg_local_sub_loaded: "ローカル字幕を読み込みました！",
    msg_translate_target: "自動翻訳ターゲット: {lang}",
    msg_player_fallback: "高機能プレーヤーの読み込みに失敗しました。基本プレーヤーを使用します。",
    btn_close: "閉じる",
    label_preview: "プレビュー",
    msg_copy_fail: "コピー失敗",
    msg_link_fail: "リンクを取得できませんでした。",
    msg_done: "完了",
    ...
    err_rename: "名前変更エラー",
    err_generic: "エラー",
    btn_download_menu: "ダウンロード / 書き出し",
    tip_download_menu: "選択項目のダウンロードまたはリンクの書き出し",
    col_created: "作成日",
    btn_filter: "フィルター",
...
<div style="font-size:13px; line-height:1.6; color:var(--pk-fg);">
    ...
    tip_player_prev: "上一个视频",
    tip_player_next: "下一个视频",
    tip_player_shuffle: "随机播放",
    tip_player_playlist: "播放列表",
    tip_player_sub: "字幕设置",
    btn_player_sub: "字幕",
    tip_player_ext: "用外部播放器打开",
    tip_player_close: "关闭 (Esc)",
    lbl_playlist: "播放列表",
    loading_subs: "正在加载字幕...",
    loading_translating: "正在翻译字幕...",
    loading_restart_player: "正在重启播放器和字幕...",
    loading_local_sub: "正在加载本地字幕...",
    msg_local_sub_loaded: "已加载本地字幕！",
    msg_translate_target: "自动翻译目标: {lang}",
    msg_player_fallback: "增强播放器加载失败，改用基础播放器。",
    btn_close: "关闭",
    label_preview: "预览",
    msg_copy_fail: "复制失败",
    msg_link_fail: "无法获取链接。",
    msg_done: "完成",
    msg_error: "发生错误",
    err_load: "加载失败",
    err_search: "搜索错误",
    ...
    err_rename: "重命名错误",
    err_generic: "错误",
    btn_download_menu: "下载 / 导出",
    tip_download_menu: "下载选中项或导出其链接",
    col_created: "创建日期",
    btn_filter: "筛选",
  ...
  var styles_default = `
    ...
    .pk-dup-toolbar { display:none; align-items:center; gap:8px; padding:8px 16px; border-bottom:1px solid var(--pk-bd); background:var(--pk-gh); overflow-x:auto; scrollbar-width:none; }
    ...
    .pk-dup-filter { height: 26px; padding: 0 6px; border: 1px solid var(--pk-bd); border-radius: 4px; background: var(--pk-bg); color: var(--pk-fg); font-size: 12px; margin-right: 6px; flex-shrink: 0; cursor: pointer; } .pk-dl-dropdown { position: relative; display: inline-flex; } .pk-dl-btn svg:last-child { opacity: 0.5; margin-left: 2px; } .pk-dl-menu { position: absolute; bottom: calc(100% + 6px); right: 0; min-width: 190px; background: var(--pk-bg); border: 1px solid var(--pk-bd); border-radius: 8px; box-shadow: 0 6px 20px rgba(0,0,0,0.2); padding: 4px; display: none; flex-direction: column; gap: 2px; z-index: 10005; } .pk-dl-menu.open { display: flex; } .pk-dl-menu .pk-btn { justify-content: flex-start; width: 100%; height: 34px; }
`;
  ...
  function createLayout(L, lang, version2) {
...
`;
  ...
  var _expandTimers = /* @__PURE__ */ new Map();
  ...
  var { rE: version } = package_namespaceObject;
  console.log("🚀 PikPak Script: LOADED from main.js");
  function setLoad(b) {
    S.loading = b;
    setLoading(b, getStrings());
  }
  ...
  async function playVideo(item, extraTracksHtml = "", startAt = 0, forceLang = null) {
    ...
    const getPlyr = () => window.Plyr || (typeof unsafeWindow !== "undefined" ? unsafeWindow.Plyr : void 0);
    const getHls = () => window.Hls || (typeof unsafeWindow !== "undefined" ? unsafeWindow.Hls : void 0);
    let usePlyr = true;
    if (!getPlyr()) {
      setLoad(true, L);
      ...
      const translateToGoogle = async (vttText, tl) => {
        ...
        for (let i = 0; i < validChunks.length; i += BATCH_SIZE) {
          ...
          for (let j = 0; j < batch.length; j++) {
            const item2 = batch[j];
            if (item2.content) {
              let transText = item2.content;
              if (translatedContents[tIdx]) {
                transText = translatedContents[tIdx];
              }
              translatedVtt += item2.tc + "\n" + transText + "\n\n";
              tIdx++;
            } else {
              translatedVtt += item2.block + "\n\n";
            }
          }
...
`;
    ...
    if (streamLink.includes(".m3u8") && HlsFn && HlsFn.isSupported()) {
      ...
      hls.on(HlsFn.Events.MANIFEST_PARSED, function() {
        ...
        if (startAt > 0) setTimeout(() => {
          if (player) player.currentTime = startAt;
          else vidEl.currentTime = startAt;
        }, 200);
      });
    } else {
    ...
    d.onclick = (e) => {
      ...
      else if (subMenu && !subMenu.contains(e.target) && e.target !== subBtn) subMenu.style.display = "none";
    };
  }
  async function openManager() {
    ...
    const updateLoadTxt2 = (txt) => updateLoadingText(txt);
    ...
    setHandlers({
      onRowClick(e, d, i, chk) {
        ...
        if (e.target.tagName === "INPUT") {
          if (chk.checked) S.sel.add(d.id);
          else S.sel.delete(d.id);
          S.lastSelIdx = i;
    ...
    async function load(isHistoryNav = false) {
      ...
      try {
        if (!S.scanning) {
          ...
          updateLoadTxt2(loadingMsgs[Math.floor(Math.random() * loadingMsgs.length)]);
          S.items = await apiList(cur.id, 1e3, (cnt) => {
            updateLoadTxt2(L.loading_fetch.replace("{n}", cnt));
          }, () => S.loadingNav);
          refresh();
        }
      } catch (e) {
    ...
    async function refresh() {
      ...
      if (S.dupMode) {
        ...
        updateLoadTxt2(L.loading_dup.replace("{p}", 0));
        await sleep(50);
        ...
        const VIDEO_EXT = /* @__PURE__ */ new Set(["mp4", "mov", "mkv", "avi", "wmv", "flv", "webm", "ts", "m4v", "3gp", "mpg", "mpeg", "rmvb", "rm", "vob", "m2ts", "f4v"]);
        const IMAGE_EXT = /* @__PURE__ */ new Set(["jpg", "jpeg", "png", "gif", "bmp", "webp", "tiff", "tif", "ico", "heic", "heif", "avif"]);
        const nameKind = (name) => {
          const dot = name.lastIndexOf(".");
        ...
        for (let i = 0; i < videos.length; i++) {
          ...
          if (i % chunkSize === 0) {
            updateLoadTxt2(L.loading_dup.replace("{p}", Math.round(i / videos.length * 100)));
            await sleep(0);
          }
    ...
    async function getResourceLinks(onProgress) {
      ...
      const uniqueByUrl = /* @__PURE__ */ new Map();
      found.forEach((item) => {
    ...
    const keyHandler = (e) => {
      ...
      if (e.key === "F2") {
        e.preventDefault();
        if (S.sel.size === 1) UI.btnRename.click();
        else if (S.sel.size > 1) UI.btnBulkRename.click();
      }
      if (e.key === "F5") {
        e.preventDefault();
        UI.btnRefresh.click();
    ...
    let lassoActive = false, lassoStartX = 0, lassoStartY = 0, lassoInitSel = /* @__PURE__ */ new Set();
      ...
      items.forEach((el2) => {
        ...
        if (shouldSelect) {
          if (!S.sel.has(id)) {
            ...
            const chk = el2.querySelector("input");
      ...
      UI.searchInput.onkeydown = async (e) => {
        ...
        if (e.key === "Enter") {
          ...
          try {
            ...
            updateLoadTxt2(L.loading_searching || "Searching...");
            while (searchQueue.length && S.scanning) {
              const curr = searchQueue.shift();
              updateLoadTxt2(L.status_scanning.replace("{n}", matchCount).replace("{s}", allFiles.length).replace("{f}", curr.name));
              const files = await apiList(curr.id, 500, (currentCount) => {
                updateLoadTxt2(L.status_scanning.replace("{n}", matchCount).replace("{s}", allFiles.length + currentCount).replace("{f}", curr.name));
              });
    ...
    UI.scan.onclick = async () => {
      ...
      try {
        while (q.length && S.scanning) {
          const curr = q.shift();
          updateLoadTxt2(L.status_scanning.replace("{n}", all.length).replace("{s}", all.length).replace("{f}", curr.name));
          const files = await apiList(curr.id, 500, (currentCount) => {
            updateLoadTxt2(L.status_scanning.replace("{n}", all.length + currentCount).replace("{s}", all.length + currentCount).replace("{f}", curr.name));
          });
          for (const f of files) {
    ...
    UI.dup.onclick = async () => {
      if (!S.dupMode) {
        if (!await showConfirm(L.msg_dup_warn)) return;
      }
      S.dupMode = !S.dupMode;
      S.dupCachedGroups = null;
      S.dupFilter = "all";
    ...
    UI.chkAll.onclick = (e) => {
      if (e.target.checked) S.display.forEach((i) => S.sel.add(i.id));
      else S.sel.clear();
      _render();
      _updateStat();
    };
    ...
    UI.btnRename.onclick = async () => {
      ...
      inp.focus();
      if (item.kind !== "drive#folder" && item.name.lastIndexOf(".") > 0) inp.setSelectionRange(0, item.name.lastIndexOf("."));
      else inp.select();
    ...
    UI.btnBulkRename.onclick = () => {
      ...
      const attachLiveEvent = (el2) => el2.addEventListener("input", updatePreview);
...
`;
    ...
    UI.btnDel.onclick = async () => {
      ...
      if (await showConfirm(L.warn_del.replace("{n}", S.sel.size))) {
        ...
        updateLoadTxt2(L.loading_batch_delete.replace("{done}", 0).replace("{total}", allIds.length));
        try {
          for (let c = 0; c < totalChunks; c++) {
            ...
            updateLoadTxt2(L.loading_batch_delete.replace("{done}", c * CHUNK + chunk.length).replace("{total}", allIds.length));
            try {
    ...
    if (UI.btnResourceCopy) {
      UI.btnResourceCopy.onclick = async () => {
        ...
        setLoad2(true);
        updateLoadTxt2(L.loading_resource_links.replace("{done}", "0").replace("{total}", S.sel.size));
        try {
          const result = await getResourceLinks((done, total) => {
            updateLoadTxt2(L.loading_resource_links.replace("{done}", done).replace("{total}", total));
          });
          const values = {
    ...
    ctx.querySelector("#ctx-ext-play").onclick = async () => {
      ...
      if (extPlayer === "potplayer") window.open("potplayer://" + link, "_self");
      else if (extPlayer === "vlc") window.open("vlc://" + link, "_self");
      else window.open("potplayer://" + link, "_self");
    };
