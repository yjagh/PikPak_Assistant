// Render module (refactor E, low-risk step): the virtualized list/grid
// renderers extracted verbatim from main.js. Pure relocation — no render
// logic changed. Owns its own view state (_gridCache/_lastListRange/
// _scrollPending), getIcon, applyDragDrop and initScrollHandler; the whole
// cluster only cross-references main.js at call time (after openManager
// populates UI and sets _h), so the circular import flattens with no TDZ.
